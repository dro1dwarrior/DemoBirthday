...
public class GCMIntentService extends GCMBaseIntentService {
	...
	protected void onMessage(Context context, Intent intent) {
		...
		Log.d("GCMIntentService-onMessage",
				"Message Received**************************" + szMessageData);
		...
		// "com.geodesic.android.universalIM.controller.IMService" );
	...
	protected void onRegistered(Context context, String registrationId) {
		// TODO Auto-generated method stub
		Log.d("GCMIntentService-onRegistered", "GCM Registered Id "
				+ registrationId);
		// IMServiceConnection.getIMService().sendRegistrationtoUM(
		// registrationId );
	...
	void ShowNotification(Context context, String szText) {
		...
		// szText, System.currentTimeMillis() );
		// notification.setLatestEventInfo( getApplicationContext(),
		// "Push Notification", szText, contentIntent );
		//

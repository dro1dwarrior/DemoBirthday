...
public class LiveLayout extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		dialog = ProgressDialog.show(LiveLayout.this, "", "Please wait...",
				true);
				...
				mHandler = new Handler() {
					...
					public void handleMessage(Message msg) {
						...
						if (xml != null && !xml.equals("") && first) {
							country.scroll(-25 + (int) (Math.random() * 50),
									4000);
	...
	public final boolean isInternetOn() {
		ConnectivityManager connec = (ConnectivityManager) LiveLayout.this
	...
	private class CountryAdapter extends AbstractWheelTextAdapter {
		...
		// Countries flags
		private int flags[] = new int[] { R.drawable.afghanistan_sq,
				R.drawable.australia_sq, R.drawable.bangladesh_sq,
				R.drawable.england_sq, R.drawable.india_sq,
				R.drawable.ireland_sq, R.drawable.newzealand_sq,
				R.drawable.pakistan_sq, R.drawable.southafrica_sq,
				R.drawable.srilanka_sq, R.drawable.westindies_sq,
